...
/**
   ...
   I make $SIMPLE to the community <3. 
...
contract SimpleTokenFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 990000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Simple Token Finance";
